...
LLMs are non-deterministic — the same prompt can produce vastly different solutions. Some will be elegant, some will miss edge cases, some will be over-engineered. Instead of rolling the dice once and hoping for the best, Horse Race:
...
- 🗳️ **Surfaces the winner democratically** using Borda count, a ranked-choice voting method resistant to strategic manipulation

The result? Consistently better code than any single generation. 💪
